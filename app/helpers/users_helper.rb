module UsersHelper
  ...
  def about_page_action
    ...
    if @user == current_user
      ...
      link_to "Friend Me", user_friends_path(current_user, :recipient_id => @user.id), method: 'post', class: "btn btn-success btn-sm pull-right", alt: "Add #{@user.profile.full_name} as a Friend"
    end
